...
var MY_WIT_TOKEN = "5HSSLZ5IRHZEJVKTQRF7YOT6NVY442FB";
$.ajax({
...
function sendStatementquery(question,callBackfunc){
var responseOb = {};
var MY_WIT_TOKEN = "5HSSLZ5IRHZEJVKTQRF7YOT6NVY442FB";
$.ajax({
         ...
         if(response.entities.intent[0].value === "affirmation" ||
            ...
            || response.entities.intent[0].value === "confirmation") {
             ...
             responseOb = {"industry":null,"answer":response.entities.intent[0].value,"location":null,"message":response._text};
              ...
              responseOb = {"industry":response.entities.intent[0].value,"answer":"none","location":null,"message":response._text};
...
sendStatementquery("yeah",callBackfunc);
sendStatementquery("perhaps",callBackfunc);
sendStatementquery("nevada",callBackfunc);
sendStatementquery("houston",callBackfunc);
sendStatementquery("oceanography",callBackfunc);
sendStatementquery("english program in texas",callBackfunc);
sendStatementquery("public relations in iowa",callBackfunc);
